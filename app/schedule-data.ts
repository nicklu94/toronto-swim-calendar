export const week = {
  ...
  "todayIndex": 5,
  "updatedLabel": "8/8 14:12",
  "nextUpdateLabel": "8/10（周一）"
} as const;
...
export const schedule: Array<{day: number; venue: VenueId; start: string; end: string; type: SwimType}> = [
  {
    "day": 1,
    "venue": "goulding-community-recreation-centre",
    "start": "10:00",
    "end": "19:55",
    "type": "Recreational Swim"
  },
  {
    "day": 1,
